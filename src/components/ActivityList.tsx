...
export const ActivityList = ({ activities, dispath } : ActivityListProps) => {
                    ...
                    return ( 
                        <div key={activity.id} className="px-5 py-10 bg-white mt-5 flex justify-between">
                            ...
                            <div className=" flex gap-5 items-center">
                                ...
                                <button onClick={ ()=> dispath({type:'set-activeId',payload:{id: activity.id}})}>
                                    <PencilSquareIcon className="h-8 w-8 text-gray-800"/>
                                </button>

                                <button onClick={ ()=> dispath({type: 'remove-activity',payload:{id: activity.id}})}>
